...
with sync_playwright() as playwright:
    ...
    # the same as:  page.locator('//div[@data-testid="login-form-email-input"]//div//input')
    ...
    # the same as: page.locator('//div[@data-testid="login-page-wrong-email-or-password-alert"]')
